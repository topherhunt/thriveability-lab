class Searcher
  ...
  SEARCHABLE_FIELDS = ["full_name^3", "title^3", "tagline^1.5", "subtitle^1.5", "interests", "description", "location", "bio_interior", "bio_exterior", "current_url", "source_name", "tags", "media_types", "published_content", "author_name", "owner", "descendants^0.5", "stage", "partners", "desired_impact", "contribution_to_world", "location_of_home", "location_of_impact", "help_needed", "q_background", "q_meaning", "q_community", "q_goals", "q_how_make_impact", "q_how_measure_impact", "q_potential_barriers", "q_project_assets", "q_larger_vision"]
