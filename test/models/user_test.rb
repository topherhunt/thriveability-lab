...
class UserTest < ActiveSupport::TestCase
  ...
  test ".most_recent returns the most recently signed-in users" do
    u3 = create :user, last_signed_in_at: 1.days.ago
    u2 = create :user, last_signed_in_at: 2.days.ago
    u1 = create :user, last_signed_in_at: 3.days.ago
    u4 = create :user, last_signed_in_at: 4.days.ago
    u5 = create :user, last_signed_in_at: 5.days.ago
